...
export function getData() {
  return [
    ...
    { title: "Adidas Yung 1", price: 5350, Image: AdidasYung1, id:2, sizes:[1,2,3,4]},
    { title: "Nike Air Force 1", price: 13999, Image: NikeAirForce1, id:3, sizes:[1,2,3,4] },
    { title: "Adidas Ozweego", price: 7550, Image: AdidasOzweegoTRGrey, id:4, sizes:[1,2,3,4] },
    { title: "Adidas Ozweego PURE", price: 9999, Image: AdidasOzweegoPURE, id:5, sizes:[1,2,3,4] },
  ];
}
